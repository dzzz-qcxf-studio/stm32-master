...
- `monitors/` - 包含 `serial_monitor_ai.js`, `serial_monitor.js`, `serial_mcp.js`, `monitor_web.ps1`, `monitor_serial.ps1`, `package.json`, `node_modules/`
- `docs/` - 包含 `MONITOR_QUICKSTART.md`, `MCP_CONFIG.md`, `PROJECT_SUMMARY.md`
- `templates/` - 包含设备驱动模板、FAL 模块模板等
